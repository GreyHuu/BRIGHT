...
#
dataset_train_path = "dataset/for_contrastive/contrastive_train.txt"
dataset_eval_path = "dataset/for_contrastive/contrastive_test.txt"
#
new_model = "./new_model/mistral-7b_chat_contrast_based_ATOMIC"
################################################################################
#
################################################################################
...
per_device_train_batch_size = 256  # Batch size per GPU for training
per_device_eval_batch_size = 256  # Batch size per GPU for evaluation
...
# SFT
################################################################################
max_seq_length = 35  # Maximum sequence length to use
...
model = AutoModelForCausalLM.from_pretrained(
    model_name,
    # "/media/data1/tfh/2023/09/fine_tuning/mistral/new_model/mistral-7b_chat_contrast_based_merge_lora_v2",
