...
dataset_train_path = "dataset/contrastive/train.txt"
dataset_eval_path = "contrastive/test_100.0.txt"

new_model = "./new_model/gpt2_xl_contrast_based_2"
################################################################################
# LoRA
################################################################################
...
learning_rate = 4e-6  # Initial learning rate (AdamW optimizer)
...
class ContrasTrainer(SFTTrainer):
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        batch_emb = sequence_output[range(sequence_output.size(0)), last_token_positions]
