...
COUNT = 20
dataset_path = f"/media/data1/tfh/2023/09/fine_tuning/llama2_7B/dataset/build_data/generate_dataset/generate_{COUNT}.json"
new_model_base_path = "/media/data1/tfh/2023/09/fine_tuning/llama2_7B/new_model/"
peft_model_id = "llama-2-chat-7b_contrast_10k_8_1_1data_2epoch"
new_peft_model = new_model_base_path + peft_model_id
# new_peft_model = "/media/data1/tfh/2023/09/fine_tuning/llama2_7B/results/checkpoint-125"
num_sentence = 10
batch_size = 1
max_new_token = 50
...
def post_process(answer):
    ...
    """
    answer = answer.strip()
    key_word = "Output entities:"
    if answer.startswith(key_word):

        answer = answer.replace(key_word, "")
